...
const InitBoard = () => {
    ...
    const startBoardGame = (vals) => {
        console.log('--== startBoardGame ', vals)
        addBoard(vals)(dispatch)
        navigate('/score')
    }
  return (
    <>
      <section class="bg-gray-200">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt="Night"
              src="https://miro.medium.com/max/786/1*GQIwPlT-lGRUQ8zcOGrXmg.jpeg"
            ...
            <div class="max-w-xl lg:max-w-3xl">
              <div class="relative -mt-16 block lg:hidden">
                ...
                <p class="mt-4 leading-relaxed text-gray-500">
                  Manage your score total
                </p>
              </div>
              <Formik
                initialValues={{
                  name: "PokerBoard",
                  players: [{ name: "", select: true, key: "player0" }],
                }}
                validate={(values) => {
                  const errors = {};
                  return errors;
              ...
              >
                {({
                  ...
                  <>
                        ...
                        <>
                          <div class="overflow-hidden overflow-x-auto rounded-lg border border-gray-200 m-2">
                            <div className="flex justify-end m-2">
                              <button
                                onClick={() =>
                                  arrayHelpers.push({ name: "", select: true, key: `player${values.players.length}` })
                                }
                    ...
                    <button
                      onClick={() => startBoardGame(values)}
                      class="m-2 inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
                    >
                      Start Game
                    </button>
                  </>
